            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full">
                <div className="border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                  <label
                    htmlFor="UserEmail"
                    className="w-full relative block overflow-hidden border-b border-gray-200 bg-transparent pt-3 focus-within:border-blue-600"
                  >
                    <input
                      type="email"
                      id="UserEmail"
                  ...
                  <a
                    className="dark:text-slate-800 group relative inline-block focus:outline-none focus:ring"
                    href="/download"
                  >
